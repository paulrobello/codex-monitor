...
final class CodexUsageCoreTests: XCTestCase {
  ...
  func testIOSSettingsExposeOpenRouterLabelEditingAndAddKeyControls() throws {
    ...
    XCTAssertTrue(iosSource.contains("openRouterCreditsBinding"))
    XCTAssertTrue(iosSource.contains("setOpenRouterKeyUsageVisible"))
    XCTAssertTrue(iosSource.contains("setOpenRouterCreditsVisible"))
    XCTAssertTrue(iosSource.contains("hideOpenRouterKeyUsage: store.settings.hideOpenRouterKeyUsage"))
    XCTAssertTrue(iosSource.contains("hideOpenRouterCredits: store.settings.hideOpenRouterCredits"))
    XCTAssertTrue(iosSource.contains("private func isOpenRouterKeyUsageLabel(_ label: String?) -> Bool"))
    XCTAssertTrue(iosSource.contains("label == \"Key limit\" || label == \"Key usage\""))
  }
  ...
  func testUsageBarsUseAccentableCustomWidgetFillAndReloadOnAppStart() throws {
    ...
    XCTAssertFalse(widgetSource.contains("When(\\.$provider, .equalTo, .openRouter)"))
    XCTAssertTrue(
      widgetSource.contains(
  ...
  func testSmallWidgetUsesCompactTwoWindowPercentSummary() throws {
    ...
    XCTAssertTrue(widgetSource.contains("keyLabel: smallWidgetKeyLabel(for: snapshot)"))
    ...
    XCTAssertTrue(widgetSource.contains("if let keyLabel = headerKeyLabel(for: entry.snapshots.first)"))
    XCTAssertTrue(widgetSource.contains("guard entry.providerID == .openRouter else"))
    ...
    XCTAssertTrue(widgetSource.contains("Text(keyLabel)"))
    XCTAssertTrue(
      widgetSource.contains(
  ...
  func testMacAppCanHideOpenRouterCreditsWindow() throws {
    ...
    XCTAssertTrue(appSource.contains("private func isOpenRouterKeyUsageLabel(_ label: String?) -> Bool"))
    XCTAssertTrue(appSource.contains("label == \"Key limit\" || label == \"Key usage\""))
  ...
  func testMakefileExposesServiceInstallTargets() throws {
    ...
    XCTAssertTrue(makefile.contains("uninstall: uninstall-service uninstall-widgets uninstall-app"))
    XCTAssertTrue(makefile.contains("uninstall-mac: uninstall"))
    XCTAssertTrue(makefile.contains("uninstall-widgets:"))
    XCTAssertTrue(makefile.contains("uninstall-app:"))
    ...
    XCTAssertTrue(makefile.contains("INSTALLED_WIDGET_EXTENSION"))
    XCTAssertTrue(makefile.contains("BUILT_WIDGET_EXTENSION"))
    ...
    XCTAssertTrue(makefile.contains("pluginkit -r \"$(INSTALLED_WIDGET_EXTENSION)\""))
    XCTAssertTrue(makefile.contains("\"$(LSREGISTER)\" -u \"$(INSTALLED_APP_BUNDLE)\""))
    XCTAssertTrue(makefile.contains("rm -rf \"$(INSTALLED_APP_BUNDLE)\""))
